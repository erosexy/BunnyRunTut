...
public class MyUnitySingletonEggsTemp : MonoBehaviour {

	private static MyUnitySingletonEggsTemp instance = null;
	public static MyUnitySingletonEggsTemp Instance {
		get { return instance; }
	}
